...
public class Albastru_departe extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        {
            telemetry.addData("bratsecund= (%.2f)", robot.bratsecund.getPosition());
            telemetry.addData("bratprincipal= (%.2f)", robot.brat.getPosition());
            telemetry.update();
        }
