...
@Autonomous(name = "test spasme")
public class test_spasme extends LinearOpMode {
    public static class Initialization {
        ...
        public void init(HardwareMap ahwMap) {
            ...
            sp1=hwMap.get(CRServo.class, "sp1");
            sp2=hwMap.get(CRServo.class,"sp2");
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.sp1.setPower(0.5);
        robot.sp2.setPower(0.5);
        waitForStart();
        runtime.reset();
...
//SCHIMBATE INTRE ELE
    ...
    public void Aranjare(){
        //
        /*robot.sp1.setPower(1);
        robot.sp2.setPower(-1);
        sleep(500);
        robot.sp1.setPower(0.2);
        robot.sp2.setPower(0.2);
        //
        sleep(2000);
        robot.sp1.setPower(-1);
        robot.sp2.setPower(1);
        sleep(500);
        robot.sp1.setPower(0);
        robot.sp2.setPower(0);*/
    }
}